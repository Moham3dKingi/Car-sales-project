...
def prediction(dynamicInput):
    ...
    InputList = list(dynamicInput.values())  
    print('Test')
    print(InputList)
    # Convert list to an array
    input_test_sample = np.array([InputList])
    print(dynamicInput)
    # input_test_sample2 = np.array([[1, 50.73, 71370.67, 9391.34, 462946.49]])
